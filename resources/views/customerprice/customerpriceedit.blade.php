...
<div class="main-container m-5">
    ...
    <form action="{{ url('customerprice/'.$customerprice->id) }}" method="post" >
            @csrf
            @method('PUT')
            <h5 class="text-primary">Edit Customer Price</h5>
            <div class="form-group row">
                <div class="col-sm-6 fw-bold">
                    ...
                    <select class="js-example-basic-single1 form-control" name="machine_id" id="machine_id">
                        ...
                        <option value="{{ $machine->id }}" {{ $machine->id == $customerprice->machine_id ? 'selected' : '' }}>
                ...
                <div class="col-sm-6 fw-bold">
                    ...
                    <select class="js-example-basic-single1 form-control" name="part_id" id="part_id">
                        ...
                        <option value="{{ $part->id }}" data-buying-price="{{ $part->buying_price }}" {{ $part->id == $customerprice->part_id ? 'selected' : '' }}>
            ...
            <div class="form-group row" id="customer_wise_form">
                <input type="hidden" name="customerwiseprice_id[]" class="customerwiseprice_id" value="{{ $customerprice->id }}">
                ...
                <div class="col-sm-2 fw-bold">
                    ...
                    <select class="form-control customer_id" name="customer_id[]">
                        ...
                        <option value="{{ $client->id }}" {{ $client->id == $customerprice->customer_id ? 'selected' : '' }}>
                            {{ $client->company_name }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="col-sm-2 fw-bold">
                    ...
                    <input type="text" readonly value="{{ $customerprice->buying_price }}" class="form-control buying_price" placeholder="Buying Price">
                </div>

                <div class="col-sm-2 fw-bold">
                    <label class="col-form-label">Selling Price<span class="text-danger">*</span></label>
                    <input type="text" name="price[]" class="form-control price" placeholder="Selling Price" value="{{ $customerprice->price }}">
                </div>

                <div class="col-sm-2 fw-bold">
                    <label class="col-form-label">Discount<span class="text-danger">*</span></label>
                    <input type="text" name="discount[]" class="form-control discount" placeholder="Discount" value="{{ $customerprice->discount }}">
                </div>

                <div class="col-sm-2 fw-bold">
                    <label class="col-form-label">Discount %<span class="text-danger">*</span></label>
                    <input type="text" name="discount_percent[]" class="form-control discountpercent" placeholder="Discount Percent" value="{{ $customerprice->discount_percent }}">
                </div>
...
$(document).ready(function() {
    ...
    let initial_part_id = $('#part_id').val();
    if (initial_part_id) {
        let initial_buying_price = $('#part_id').find('option:selected').data('buying-price');
        $('.buying_price').val(initial_buying_price);
    }
