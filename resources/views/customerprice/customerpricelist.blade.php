        ...
        <form action="{{  url('/customerprice') }}" method="post">
            ...
            <div class="form-group row" id="customer_wise_form">
                ...
                <div class="col-sm-2 fw-bold">
                    ...
                    <input type="text" name="price[]" class="form-control price" placeholder="Enter Selling Price">
                </div>

                <div class="col-sm-2 fw-bold">
                    <label class="col-form-label">Discount<span class="text-danger">*</span></label>
                    <input type="text" name="discount[]" class="form-control discount" placeholder="Enter Discount">
                </div>
            ...
            success: function(response) {
                ...
                if (response.length) {
                    response.forEach(function(spare) {
                        $('#part_id').append(
                            '<option value="' + spare.id + '">' + spare
                            .description + ' [' + spare.part_no + ']</option>'
                        );
                    });
                } else {
