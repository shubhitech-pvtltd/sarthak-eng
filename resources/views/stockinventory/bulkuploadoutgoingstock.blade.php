...
<div class="main-container m-5">
    <div class="clearfix">
        <div class="pull-left">
            <h3 class="text-blue">Bulk Upload - Outgoing Stock</h3>
        </div>
        <ol class="breadcrumb float-right">
            <li class="breadcrumb-item"><a href="{{ url('/') }}">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="{{ url('/stockinventory/outgoingstock') }}">Outgoing Stock</a></li>
            <li class="breadcrumb-item">Bulk Upload</li>
        </ol>
    </div>

    <div class="pd-20 bg-white border-radius-4 box-shadow">
        <form action="{{ url('/stockinventory/outgoingstock/bulkupload/submit') }}" method="post" enctype="multipart/form-data">
            @csrf
                ...
                <div class="row">
                    <div class="row col-md-12">
                        <h6 class="m-2">CSV File 
                            ...
                            <a class="text-primary" href="{{ url('csvfiles/outgoingstocksample1.xlsx') }}" download="">Download Sample</a>
                        </h6>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Outgoing<span class="text-danger">*</span></td>
                                        <td>Yes</td>
                                        <td>Integer</td>
                                        <td>N/A</td>
                                    </tr>
