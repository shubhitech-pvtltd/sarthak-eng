...
<div class="main-container m-5">
    <div class="clearfix">
        <div class="pull-left">
            <h2>Create Outgoing Stock</h2>
        </div>
        <ol class="breadcrumb float-right">
            <li class="breadcrumb-item"><a href="{{ url('/') }}">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="{{ url('/outgoingstock') }}">Outgoing Stock</a></li>
            <li class="breadcrumb-item active textChng">Create Outgoing Stock</li>
        </ol>
    </div>
    ...
    <div class="pd-20 bg-white border-radius-4 box-shadow">
        ...
        <div class="col-md-12">
            <form action="{{ url('/stockinventory/outgoingstock') }}" method="post">
            ...
            <div class="form-group row">
                    ...
                    <div class="col-sm-6 fw-bold">
                        ...
                        <input type="number" id="quantity" name="quantity" value="" class="form-control quantity" readonly>
                        </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-6 fw-bold">
                    ...
                    <div class="col-sm-6 fw-bold">
                        ...
                        <input type="number" id="outgoing" name="outgoing" value="" class="form-control" required>
                        </div>
                </div>
...
$(document).ready(function() {
    ...
    const stockInHandInput = document.getElementById('stock_in_hand');

    function calculateStockInHand() {
        const quantity = parseFloat(quantityInput.value) || 0;
        const outgoing = parseFloat(outgoingInput.value) || 0;
        const stockInHand = quantity - outgoing;

        stockInHandInput.value = stockInHand >= 0 ? stockInHand : 0;
    }

    calculateStockInHand();

    outgoingInput.addEventListener('input', calculateStockInHand);
});
